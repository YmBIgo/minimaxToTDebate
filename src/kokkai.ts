...
const searchParticipantPrompt = `あなたは国会議員情報の抽出専門家です。
...
const pickTopicsPrompt = `あなたは国会議員の答弁を分析する専門家です。
...
main("kokkai_raw/speeches/speech_122103968X00720260415,2026-04-15.txt").catch((error) => {
